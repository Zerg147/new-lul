import type { AgentInfo, ModelInfo, OllamaApiResponse, OllamaModel, PlatformInfo } from './types';

export const WORK_DIR_NAME = 'project';
export const WORK_DIR = `/home/${WORK_DIR_NAME}`;
export const MODIFICATIONS_TAG_NAME = 'BuildXtreme_file_modifications';
...
const staticModels: ModelInfo[] = [
  ...
  { name: 'chatgpt-4', label: 'Greenfield Code', provider: 'Custom'},
  ...
  { name: 'gpt-4o', label: 'gpt-4o', provider: 'AzureOpenAI' },
  { name: 'anthropic.claude-3-5-sonnet-20240620-v1:0', label: 'Claude Sonnet 3.5 v1', provider: 'AWS Bedrock' },
];

const staticAgents: AgentInfo[] = [
  {
    name: 'Requirement Mapping',
    desc: 'Jira to TRD Generation',
  },
  {
    name: 'Greenfield Code Synthesis',
    desc: 'TRD to Code Generation for Greenfield',
  },
  {
    name: 'Brownfield Code Evolution',
    desc: 'Code Enhancement for Brownfield',
  },
  {
    name: 'Test Blueprint Creator',
    desc: 'Unit Test Generations',
  },
  {
    name: 'Deployment Orchestrator',
    desc: 'Code Deployments',
  },
]

const staticPlatforms: PlatformInfo[] = [
  {
    name: "BuildXtreme AI",
    desc: "",
  },
...
export let AGENT_LIST: AgentInfo[] = [...staticAgents];
export let PLATFORM_LIST: PlatformInfo[] = [...staticPlatforms];
